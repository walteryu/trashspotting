# 11 - Keras implementation of RetinaNet object detection.
...
PATH_TO_RN = '/content/keras-retinanet'
PATH_TO_SNAP = '/content/keras-retinanet/snapshots'

# !rm -rf keras-retinanet
# !git clone https://github.com/walteryu/keras-retinanet.git
# %cd $PATH_TO_RN
